		  ...
		  <span class="field-content">
			  <div class="sharethis-wrapper">
					...
					<span class="chicklets email">
						<a href='mailto:Article@MortgageSpeak.com?subject=<?php print $title; ?>&body=I wanted to share this article with you: <?php print ($url. '     ' .$body); ?>' class="email" target="_blank" title="Email this content"><img src="/sites/all/themes/mortgage_new_theme/images/mail1.png" /></a>
					</span>
				</div> 
				 <!-- Flag link-->
				 <?php print $row['ops'];?>
