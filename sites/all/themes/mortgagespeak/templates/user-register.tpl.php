...
?>
<div class="register-bottom-text"><span>By Clicking the button, you agree to our <a href="#">terms and conditions</a>.</span><span>Already have an account? <a href="<?php print $base_url; ?>/user">Log in here.</a></span></div>
</div>